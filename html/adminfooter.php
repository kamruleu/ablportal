<!-- Page Footer -->
    ...
    <script type="text/javascript" src="<?php echo URL; ?>asset_admin/dist/js/demo/summernote.js"></script>
 <!-- Mask Plugin -->
...
//Hint to mention Summernote
$(".hint2mention").summernote({
    height: 100,
    placeholder: 'type starting @ for hint',
    hint: {
        mentions: [ 'Apple', 'Boy', 'Cat', 'Dog', 'Elephent', 'Fox', 'Gun', 'Hulk', 'Ink', 'Komal' ],
        match: /\B@(\w*)$/,
...
//On Click Intilize summernote
var edit = function() {
    $('.click2edit').summernote({focus: true});
};
//On Click Save data and destroy summernote
var save = function() {
