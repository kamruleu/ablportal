<?php
class Retailerldc_model extends Model{
    function __costruct(){
        parent::__construct();
    }
    ...
    function ablitemlist($text){
        ...
        return $this->db->select("`seitem` t",array("xitemcode as itemcode,xdesc as itemdesc,xstdprice as mrp,xdp as bv,xstdcost as cost"), " zactive=1 and xcitem='All Operation' and xsource='LDC' and xdesc like '%".$text."%'");
    }
