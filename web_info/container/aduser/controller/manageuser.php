 ...
 class Manageuser extends Controller{
    ...
    private function intializeform(){
        ...
        $this->formfield = array(
            ...
            "userrole"=>array("required"=>"*","label"=>"Role","ctrlfield"=>"zrole", "ctrlvalue"=>array(), "ctrlvalid"=>array(), "ctrltype"=>"select","ctrlselected"=>"", "codetype"=>"Acc Level3","rowindex"=>"2"),
    ...
    function saveuser(){
        ...
        $inputs = new Form();
            ...
            $onduplicate = 'on duplicate key update zuserfullname=VALUES(zuserfullname), zaltemail=VALUES(zaltemail),
                            zrole=VALUES(zrole), zusermobile=VALUES(zusermobile)';
    ...
    function finduser(){
        ...
        if($userid!=""){
            $conditions[]="zemail like ?";
            $params[]='%'.$userid.'%';
        }
        if($username!=""){
            $conditions[]="zuserfullname like ?";
            $params[]='%'.$username.'%';
        }
        if($useremail!=""){
            $conditions[]="zaltemail like ?";
            $params[]='%'.$useremail.'%';
        }
        if($usermobile!=""){
            $conditions[]="zusermobile like ?";
            $params[]='%'.$usermobile.'%';
        }

        //Logdebug::appendlog(serialize($conditions));

        $userdt =  $this->model->getuser($conditions,$params);  
           ...
           //-----------------------
               ...
               //-----------------------
                ...
                $('#searchuser').on('click', function(){
                    ...
                    var url = 'http://localhost/bdvendor/manageuser/finduser';
