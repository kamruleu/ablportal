...
class Retailer extends Controller{
	...
	function createretailer(){
		...
		try{
			...
			if($success>0){				
				$sendsms->send_single_sms('আপনার রিন '.$rin.', পাসওয়ার্ড '.$rawpass.' এবং আপনার পিন '.$pin, $cusdt[0]['mobile']);
	...
	/*
	আমারবাজার এর বানিজ্যিক ভূবনে আপনাকে স্বাগতম। আপনার রিটেইলার রেজিষ্ট্রেশন সম্পন্ন হয়েছে। আপনার রিন '.$rin.', পাসওয়ার্ড '.$rawpass.' এবং আপনার পিন '.
	*/
