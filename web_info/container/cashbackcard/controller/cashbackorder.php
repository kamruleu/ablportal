<?php
class Cashbackorder extends Controller{
    ...
    function init(){
		...
		$this->view->render("templateadmin","abr/cashbackorder_view");
    }
    ...
    function script(){
        ...
        $('#checkout').on('click', function(){
            ...
            $.ajax({
                ...
                type : \"POST\",                                  				
                data : {customer:$('#mrin').val(),refrin:\"".Session::get('suser')."\",company:'',outlet:'',doc:'99',doctype:'Cashback Card Order',odcid:'',cusname:$('#delname').val(),add1:$('#deladd').val(),add2:'',city:'Dhaka',district: 'Dhaka',postal:1209,callbackurl:\"".URL."cashbackorder\",mobile:$('#mobile').val(),customertype:\"Retailer\",apikey:\"36cfce7372fc99723569236e883dc4db39669cdf116a57d6d126e05fdea7be3c\",itemdt:[{itemcode:'ABL-CS-0001',itemdesc:'NA',rate:$('#reqamt').html(),qty:'1',bv:'0'}]}, 
                dataType: 'json',
                beforeSend:function(){	
