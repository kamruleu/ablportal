...
class Getcode extends Controller{
    ...
    function script(){
        ...
        $('#confcodetype').on('change',function(){
            if($('#confcodetype').val()=='EXPRESS Card Payment'){
                $('#idtypediv').show();
                $('#reqamt').html('0');
                $('#cindiv').show();
                $('#rindiv').hide();
        ...
        $('#checkout').on('click', function(){
            ...
            //var op = $('#confcodetype').val()
            var op = $('#confcodetype').val()
            var msg = 'ডিসবার্সমেন্ট একাউন্ট নং পরিবর্তন এর অনুরোধ এসেছে, পরিবর্তন করতে চাইলে'
            if(op=='Disbursement Account Update'){
                msg = 'ডিসবার্সমেন্ট একাউন্ট নং পরিবর্তন এর অনুরোধ এসেছে, পরিবর্তন করতে চাইলে'
            }
            if(op=='BIN Transfer'){
                msg = 'বিন ট্রান্সফার এর অনুরোধ এসেছে, ট্রান্সফার করতে চাইলে'
            }
            if(op=='ODC Apply'){
                msg = 'ODC আবেদনের অনুরোধ এসেছে, আবেদন করতে চাইলে'
            }
            if(op=='EXPRESS Card Payment'){
                msg = 'এক্সপ্রেস কার্ড আবেদন এর অনুরোধ এসেছে, আবেদন করতে চাইলে';
