                    ...
                    <div class="page-title">
                        ...
                        <div class="col-12">
                                <ul class="nav nav-pills nav-pills-danger">
                                    <li class="nav-item">
                                            <a class="nav-link active" href="#posenrty" data-toggle="tab"><i class="far fa-truck mr-2"></i>Stock Transfer</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="#invoicelist" data-toggle="tab"><i class="far fa-file-alt mr-2"></i>My Transfered List</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link" href="#receivelist" data-toggle="tab"><i class="far fa-file-alt mr-2"></i>My Receive List</a>
                                        </li>
                            ...
                            <div class="panel">
                                ...
                                <div class="panel-body">
                                    ...
                                    <li class="nav-item">
                                            <a class="nav-link active" href="#customerlist" data-toggle="tab"><i class="far fa-user mr-2"></i>Retailer list</a>
                                        </li>
                                        <li class="nav-item">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane" id="productlist">
                                            <div class="row no-gutters mb-1">
                                                ...
                                                <div class="col">
                                                    <div class="input-group">
                                                        <input type="text" name="ptnno" id="ptnno" class="form-control form-control-sm" placeholder="PTN No">                                                
                                                    </div>                                            
                                                </div>
                                            </div>
                                ...
                                <div class="col mt-2">
                                <div class="font-weight-bold text-center align-middle mb-4"><span>Transfer Detail</span></div>  
                                <hr>      
                                    <div>
                                        <div class="row"> 
                                            <div class="col font-weight-bold">Txn :</div> <div class="col font-weight-bold text-left" id="invoiceno"></div>
                                            <div class="col font-weight-bold">Date: </div><div class="col font-weight-bold text-left" id="entrydate"></div>
                                        </div>
                                        <div class="row mt-2"> 
                                            <div class="col font-weight-bold">RIN :</div> <div class="col font-weight-bold text-left" id="cin"></div>
                                            <div class="col font-weight-bold">Retailer: </div><div class="col font-weight-bold text-left" id="cinname"></div>
                                        </div>
                                        <div class="bg-info"><span class="text-white"><strong>Transfered Items</strong></span></div>        
                                ...
                                <div class="panel-footer text-right">
                                    <button class="btn btn-info mr-2" id="confirmsales">Confirm</button>
                                        ...
                                        <div class="tab-pane" id="receivelist">
                                            <div class="panel">
                                                <div class="panel-body">                                                
                                                    <div class="row no-gutters">
                                                        <div class="col-6">
                                                            <div class="input-group">
                                                                <input type="text" id="tcvbystr" class="form-control form-control-sm" placeholder="Search Invoice">                                                
                                                            </div>                                            
                                                        </div>
                                                        <div class="col-3">
                                                            <div class="input-group">
                                                                <select class="form-control form-control-sm" id="rcvbytype">
                                                                    <option>All</option>
                                                                    <option>by Txn</option>
                                                                    <option>by RIN</option>
                                                                    <option>by Customer Name</option>
                                                        ...
                                                        <div class="col-3 ml">
                                                                <button  id="btnrcvtxn"  class="btn btn-sm btn-primary btn-pill ml-1"><i class="fa fa-search mr-1"></i>Search</button>
                                                        </div>
                                             
                                                        <div class="col-12 mt-4">
                                                            <div  style="overflow-y:scroll; height:600px;">
                                                                <div class="table-responsive">
                                                                    <table class="table table-sm" id="rcvtable">
                                                                        <thead>
                                                                        <tr>
                                                                            <th>Date</th>                                                            
                                                                            <th>Txn No</th>
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                            <div class="modal-header">
                                                <h4 class="modal-title">Transfered Item Detail</h4>
