                        ...
                        <div class="page-title">
                            ...
                            <div class="col-12">
                                <ul class="nav nav-pills nav-pills-danger">
                                    <li class="nav-item">
                                            <a class="nav-link active" href="#posenrty" data-toggle="tab"><i class="fa fa-cart-plus mr-2"></i>Order Cart</a>
                                        </li>
                                        <li class="nav-item">
                                                ...
                                                <div class="panel">
                                                    ...
                                                    <div class="panel-body">
                                                        ...
                                                        <li class="nav-item">
                                                            ...
                                                            <li class="nav-item">
                                                                <a class="nav-link" href="#delinfo" data-toggle="tab"><i class="fa fa-truck mr-2"></i>Delivery Information</a>
                                                            </li>
                                                            <li class="nav-item">
                                                        ...
                                                        <div class="tab-content">
                                                            ...
                                                            <div class="tab-pane" id="delinfo">
                                                            <form id="delform">
                                                                    <div class="row mb-1">
                                                                        <div class="col">
                                                                            <div class="input-group">
                                                                            <select class="form-control form-control-sm" id="company" name="company" placeholder="Select Company">
                                                                        ...
                                                                        <div class="col">
                                                                            <div class="input-group">
                                                                            <select class="form-control form-control-sm" id="outlet" name="outlet" placeholder="Select Outlet">                         
                                                                                <option default>Select Outlet</option>
                                         <option default>Head Office</option>                                   </select>
                                                                            </div>                                            
                                                                        </div>
                                                                    </div>
                                                                     <div class="row mb-1">
