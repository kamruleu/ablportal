            ...
            <main>
                <div class="row contacts">
                    ...
                    <div class="col invoice-details">
                        ...
                        <div class="to">Contact Name : <?php echo $this->invdata['header'][0]['cusname'];?></div>                        
                        <div class="address">Address : <?php echo $this->invdata['header'][0]['cusadd'];?></div>
                        <div class="email">Phone : <?php echo $this->invdata['header'][0]['cusmobile'];?></div>
                ...
                <table>
                    ...
                    <tbody>
                    <?php $i = 0; $total = 0; foreach($this->invdata['detail'] as $key=>$value){ $i++; $total = $total+floatval($value['rate'])*floatval($value['qty']); ?>
                        <tr>
