                            ...
                            <div class="panel panel-default">
                                <div class="panel-head">
                                    <div class="panel-title">
                                        <span class="panel-title-text">New RFID Application</span>
                                    </div>
                                </div>
                        ...
                        <div class="col-12">
                                <ul class="nav nav-pills nav-pills-danger">
                                    <li class="nav-item">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link" href="#retailerreg" data-toggle="tab" id="tabretailerreg"><i class="far fa-file-alt mr-2"></i>New RFID Application</a>
                                        </li>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-4">
                                                                <div>
                                                                    ...
                                                                    <span  class="form-text">Enter CIN Number</span>
                                                                </div>
                                                            </div>
                                                            <div class="col-4">
                                                                <div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-4">
                                                                <div>
                                                                    ...
                                                                    <span  class="form-text">Please provide correct NID</span>
                                                                </div>
                                                            </div>
                                                            <div class="col-4">
                                                                <div>
                                                                    ...
                                                                    <span  class="form-text">Father name is mandetory</span>
                                                                </div>
                                                            </div>
                                                            <div class="col-4">
                                                                <div>
                                                                    ...
                                                                    <span  class="form-text">Mother name is mandetory</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-4">
                                                                <div>
                                                                    ...
                                                                    <span  class="form-text">Mandetory Field</span>
                                                                </div>
                                                            </div>
                                                            <div class="col-4">
                                                                <div>
                                                            ...
                                                            <div class="col-4">
                                                                ...
                                                                <label for="relationship">Relationship</label>
                                                                    ...
                                                                    <span  class="form-text">Relationship is mandetory</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
