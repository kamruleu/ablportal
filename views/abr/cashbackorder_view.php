                                ...
                                <div class="panel-body">
                                    ...
                                    <form id="customerform">
                                        <div class="row">
                                            ...
                                            <div class="col-4">
                                                <div>
                                                    <label id="rin">Delivery Name</label>
                                                    <input type="text" class="form-control form-control-sm" id="delname" name="delname" placeholder="Delivery Name">
                                                    <p class="form-text text-danger">Delivery Name is mandetory!<span></span></p>
                                                </div>
                                            </div>  
