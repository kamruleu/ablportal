...
if (!defined('PAYGATE_URL')) {
    define('PAYGATE_URL', 'https://portal.amarbazarltd.com/paynow/');
}
                ...
                if ($child->getname()=="conf"){
                    if (!defined('LIBS')) { 
                     ...
                     if(substr((string)$child->url, -1)=="/"){
                        if (!defined('URL')) { 
                            define('URL','http://'.$_SERVER['HTTP_HOST'].''.(string)$child->url.'ablportal/');
                        }
                     }else{
                        if (!defined('URL')) {
                         define('URL','http://'.$_SERVER['HTTP_HOST'].''.(string)$child->url.'ablportal/');
                        ...
                        if (!defined('PROJECT_PATH')) {     
                            define('PROJECT_PATH', 'http://'.$_SERVER['HTTP_HOST'].''.(string)$child->url.'ablportal/');
                        }   
                    if (!defined('APPNAME'))      
